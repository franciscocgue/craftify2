...
export function sortCollisionsDesc(
    val1: { data: { droppableContainer: { data: { current: any } } } },
    val2: { data: { droppableContainer: { data: { current: any } } } },
) {
 ...
 */
export function isPointWithinRect(point: Coordinates, rect: ClientRect): boolean {
...
const myPointerWithin: CollisionDetection = ({
    ...
    for (const droppableContainer of droppableContainers) {
        ...
        const rect: ClientRect | undefined = droppableRects.get(id);
